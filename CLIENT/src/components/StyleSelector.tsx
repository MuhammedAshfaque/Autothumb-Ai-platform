...
import { ChevronDownIcon, CpuIcon, ImageIcon, PenToolIcon, SparkleIcon } from 'lucide-react';
...
const StyleSelector = ({value, onChange, isOpen, setIsOpen} : {value: ThumbnailStyle; onChange: (style: ThumbnailStyle)=> void; isOpen: boolean; setIsOpen: (open: boolean)=> void}) => {
  ...
  return (
    <div className='relative space-y-3 dark'>
      ...
      {isOpen && (
        <div className='absolute bottom-0 z-50 mt-1 w-full rounded-md border borer-white/12 bg-black/20 backdrop-blur-3xl shadow-lg'>
